...
export default function DesktopHome() {
  return (
    <div className="bg-slate-50 min-h-[calc(100vh-73px)] py-12 px-6">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm max-w-3xl mx-auto text-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input type="text" placeholder="Enter starting terminal..." className="flex-1 border border-slate-200 rounded-xl p-3 text-sm bg-slate-50" />
            <input type="text" placeholder="Enter destination point..." className="flex-1 border border-slate-200 rounded-xl p-3 text-sm bg-slate-50" />
            <Link href="/routes" className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-xl transition flex items-center justify-center">
              Search
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-2">
            ...
            <Link href="/dashboard" className="inline-block text-xs font-semibold text-blue-600 pt-2 hover:underline">Open Live Feed →</Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-2">
            ...
            <Link href="/routes" className="inline-block text-xs font-semibold text-blue-600 pt-2 hover:underline">Map Routes →</Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-2">
            ...
            <Link href="/about" className="inline-block text-xs font-semibold text-blue-600 pt-2 hover:underline">Read Story →</Link>
          </div>
        </div>
