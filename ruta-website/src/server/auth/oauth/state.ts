...
import { appendCookie, serializeCookie } from '@/server/auth/cookies';
...
export function writeOAuthState(res: NextApiResponse, payload: OAuthStatePayload) {
...
export function readOAuthState(req: NextApiRequest): OAuthStatePayload | null {
...
export function clearOAuthState(res: NextApiResponse) {
  appendCookie(
    res,
