...
export default function RouteExplorer() {
  return (
    <div className="h-[calc(100vh-73px)] flex flex-col md:flex-row overflow-hidden">
      <PageMeta title="Routes" description="Compare transit routes across Metro Manila and pick the fastest way to your destination." />
      <div className="w-full md:w-96 bg-white border-r border-slate-200 p-6 overflow-y-auto flex flex-col justify-between">
        <div><h2 className="text-xl font-bold text-slate-900 mb-4">Route Finder</h2><div className="space-y-3 mb-6"><TextField label="Origin" type="text" defaultValue="Quezon City" /><TextField label="Destination" type="text" defaultValue="Makati CBD" /></div><h3 className="font-bold text-sm text-slate-400 uppercase tracking-wider mb-2">Suggested Routes</h3><div className="space-y-2"><RouteOptionCard selected title="MRT-3 Alternative" duration="42 mins" description="Best efficiency route, slight walking required." /><RouteOptionCard title="EDSA Bus Carousel" duration="58 mins" description="Heavy traffic warning near Cubao." /></div></div>
